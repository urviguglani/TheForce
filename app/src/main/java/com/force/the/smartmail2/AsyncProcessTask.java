...
import ABBY.Client;
import ABBY.ProcessingSettings;
import ABBY.Task;
...
public class AsyncProcessTask extends AsyncTask<String, String, Boolean> {
    ...
    protected void onPostExecute(Boolean result) {
        ...
        Toast.makeText(activity, "updating results", Toast.LENGTH_LONG).show();
    ...
    protected Boolean doInBackground(String... args) {
        ...
        try {
            ...
            restClient.applicationId = "SmartMail";
            // You should get e-mail from ABBYY Cloud OCR SDK service with the application password
            restClient.password = "58ELYjE42PjF/XTLMnZoH3Bd ";
            Toast.makeText(activity, "created client", Toast.LENGTH_LONG).show();
            ...
            publishProgress("checking if installation exists in server");
